...
//        
//        FileGenerator fg = new FileGenerator("OneBlockASCIIOneBuffer.txt", 2);
//        fg.generateFile(FileType.ASCII);
//        
//        assertFalse(CheckFile.check("OneBlockASCIIOneBuffer.txt"));
//        
//        String[] listS = new String[3];
//        listS[0] = "OneBlockASCIIOneBuffer.txt";
//        listS[1] = "2";
//        listS[2] = "stats_OneBlockASCIIOneBuffer.txt";
//        Quicksort.main(listS);
//        
//        assertTrue(CheckFile.check("OneBlockASCIIOneBuffer.txt"));
//    }

public void testTenBlockASCIITenBuff() throws Exception{
    
    FileGenerator fg = new FileGenerator("TenBlockASCIITenBuff.txt", 10);
    fg.generateFile(FileType.ASCII);
    
    assertFalse(CheckFile.check("TenBlockASCIITenBuff.txt"));
    
    String[] listS = new String[3];
    listS[0] = "TenBlockASCIITenBuff.txt";
    listS[1] = "4";
    listS[2] = "stats_TenBlockASCIITenBuff.txt";
    Quicksort.main(listS);
    
    assertTrue(CheckFile.check("TenBlockASCIITenBuff.txt"));
}
